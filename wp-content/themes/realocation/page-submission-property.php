<?php
/**
 * Template Name: Property Submission Form
 */
?>
...
<?php get_header(); ?>
    ...
    <div id="main-content" class="col-md-12">
        ...
        $form = hydra_get_frontend_submission($id, 'property');
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-md-push-9">
                ...
                <h3><i class="fa fa-location-arrow"></i><?php print __('Location', 'aviators'); ?></h3>

                <div class="box">
                    <?php $renderer->renderField('hf_property_location'); ?>
                </div>


                <h3><i class="fa fa-key"></i><?php print __('Rooms', 'aviators'); ?></h3>

                <div class="box">
                    <?php $renderer->renderField('hf_property_rooms'); ?>
                </div>
            </div>
            ...
            <div class="col-md-9 col-md-pull-3">
                ...
                <h3><i class="fa fa-picture-o"></i><?php print __('Gallery', 'aviators'); ?></h3>

                <div class="box">
                    <?php $renderer->renderField('hf_property_gallery'); ?>
                </div>

                <h3><i class="fa fa-map-marker"></i><?php print __('Map', 'aviators'); ?></h3>

                <div class="box">
                    <?php $renderer->renderField('hf_property_map'); ?>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <?php $tos = aviators_submission_get_tos('property'); ?>
                    <?php if($tos): ?>
                        <?php print $agreement; ?>
