...
class AviatorsLauncher {
    ...
    public function registerMenu($defaultItem) {
        if ( defined( 'AVIATORS_SETTINGS_CAPABALITY' ) ) {
            $capabality = AVIATORS_SETTINGS_CAPABALITY;
        } else {
            $capabality = 'manage_options';
        }

        add_menu_page(__('One-Click Install', 'aviators'), __('One-Click Install', 'aviators'), $capabality, 'launcher', array(
            $this,
            'page',
