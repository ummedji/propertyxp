    ...
    class TGM_Plugin_Activation {
        ...
        protected function do_plugin_install($plugin = NULL) {
            ...
            if (isset($_GET['plugin']) && ((isset($_GET['tgmpa-install']) && 'install-plugin' == $_GET['tgmpa-install'])
                ...
                $install_type = ! empty( $install_type ) ? $install_type : null;
    ...
    class TGMPA_List_Table extends WP_List_Table {
        ...
        protected function _gather_plugin_data() {
            ...
            foreach (TGM_Plugin_Activation::$instance->plugins as $plugin) {
                $plugin_version = ! empty( $plugin['version'] ) ? $plugin['version'] : false;

                if (is_plugin_active($plugin['file_path']) && version_compare($installed_plugins[$plugin['file_path']]['Version'], $plugin_version, '>')) {
                    continue;
                ...
                $table_data[$i]['version'] = $plugin_version;
