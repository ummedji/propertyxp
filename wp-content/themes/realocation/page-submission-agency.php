<?php
/**
 * Template Name: Agency Submission Form
 */
?>
...
<div id="main-content" class="col-md-12">
    ...
    if (isset($_GET['id'])) {
        ...
        $form = hydra_get_frontend_submission($id, 'agency');
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-md-push-9">
            ...
            <div class="box">
                <?php $renderer->renderField('hf_agency_social'); ?>
            </div>

            <h3><i class="fa fa-mobile-phone"></i><?php print __('Contact', 'aviators'); ?></h3>
            <div class="box">
                <?php $renderer->renderField('hf_agency_mail'); ?>
                <?php $renderer->renderField('hf_agency_phone_number'); ?>
                <?php $renderer->renderField('hf_agency_skype'); ?>
            </div>
        </div>
