...
function aviators_pagination() {
    ...
    else printf( '<li class="prev disabled"><a tabindex="-1"><i class="fa fa-angle-left"></i></a></li>' );
//        printf( '<' )
    ...
    else printf( '<li class="next disabled"><a tabindex="-1"><i class="fa fa-angle-right"></i></a></li>' );
