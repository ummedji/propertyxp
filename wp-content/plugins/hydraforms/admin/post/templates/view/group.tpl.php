<li class='fieldset parent <?php if($set->hidden) { print 'hidden-item'; } ?>' id="item_<?php print $set->id; ?>">
  <div class="fieldset-content">
    <div class="fieldset-title">
      ...
      <div class="inputs action">
        <?php print $formOutput['form_fields'][$set->id]['formatter']; ?>
        ...
        <a id="hide-<?php print $set->id; ?>" class="hide-action" href="#">
          <img src="<?php print get_site_url(); ?>/wp-content/plugins/hydraforms/assets/img/icon-eye.png">
        </a>

        <a class="delete" href="<?php print $this->createRoute('field', 'delete', array('id' => $set->id, 'post_type' => $post_type, 'view_name' => $view_name)); ?>">
          <img src="<?php print get_site_url(); ?>/wp-content/plugins/hydraforms/assets/img/icon-trash.png">
        </a>

        <a id="settings-<?php print $set->id; ?>" class="settings-action" href="#">
  ...
  <div class="formatter-settings formatter-settings-group">
    <?php print $formatterSettings[$set->id]; ?>
  </div>
